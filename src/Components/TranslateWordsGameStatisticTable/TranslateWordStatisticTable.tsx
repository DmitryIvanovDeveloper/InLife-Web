...
export default function TranslateWordGameTable(props: ITranslateWordGameTableProps) {
    ...
    useEffect(() => {
        ...
        const uniqueWordsGameIds = [...new Set(props.translateWordsGameStatistics
            .filter(statistic => isDateSame(statistic.createdAt, selectedDate))
    ...
    return (
        ...
        <AppBarCustom name="Translate Word"/>
                        ...
                        <TableRow>
                            <TableCell>
                                <StudentCalendarActivity 
                                    ...
                                    highlightDates={props.translateWordsGameStatistics.map(s => s.createdAt)} 
                                    date={selectedDate}
                            />
                            </TableCell>
